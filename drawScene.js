function drawScene(sceneParams) {
	...
	var mesh = new THREE.Mesh( new THREE.BoxGeometry( 2, 2, 80 ), poleMat );
	mesh.position.set( -135, 150, -100 );
	scene.add( mesh );
